...
const { SummerInternshipAdd, SummerInternshipDisplay, SummerInternshipImageDisplay, SummerInternshipImagesDisplay, SummerInternshipDelete, SummerInternshipCompanyImageDisplay, SummerInternshipTopInternsImagesDisplay, SummerInternshipStudentUpdate, SummerInternshipStudentAdd } = require("../Controllers/SummerInternship.js");
...
router.post("/SummerInternship/SummerInternship_student_Update/:_id", formidable(), SummerInternshipStudentUpdate);
router.post("/SummerInternship/SummerInternship_student_add/:_id", formidable(), SummerInternshipStudentAdd);
