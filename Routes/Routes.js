...
router.post("/Alumni/AlumniEvent_Add", authchecker, formidable(), AluminEventAdd);
router.post("/Alumni/AlumniEventImages_Delete/:_id/:Image_id", authchecker, AluminImagesDelete);
router.post("/Alumni/AlumniEvent_Delete/:_id", authchecker, AluminiEventDelete);
router.get("/Alumni/AlumniEvent_Display", AluyminiEventDisplay);
router.get("/Alumni/AlumniEventMainImage_Display/:_id", AluminiEvenmaiImageDisplay);
router.get("/Alumni/AlumniEventImages_Display/:_id/:Image_id", AluminImagesDisplay);
